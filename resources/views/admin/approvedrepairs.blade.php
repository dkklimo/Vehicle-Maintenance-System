  ...
  <body>
    ...
    @include('admin.nav')
        ...
        <div class="col-md-4">
           ...
           <a href="{{url('exportapproved')}}"> <button style="margin-right:10px;" class="btn btn-success">Excel</button></a>
            <button style="margin-right:10px;" class="btn btn-success">PDF</button>
            </div>
        </div>
        <div class="col-md-3">
        <div class="col-sm-12">
            <form action="{{url('searchapprove')}}" method="GET">
              @csrf
    ...
    <div class="row ">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Approved Repairs</h4>
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>  
                          ...
                          <tr>
                            <td><a href="{{url('complete',$repairs->id)}}"><i class="mdi mdi-check text-danger"></i></a></td>
                            <td>{{$repairs->name}}</td>
                            ...
                            <td><a onclick="return confirm('You are about to delete a Repair Record');" href="{{url('deleterepair',$repairs->id)}}"><i class="mdi mdi-delete text-danger"></i></a></td>
                          </tr>
                          @endforeach
                        </tbody>
                      </table>
