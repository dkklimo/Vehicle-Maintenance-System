                    ...
                    <form class="form-sample" method="POST" action="{{url('servicedata')}}" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input style="color: #fff; background-color:transparent;" type="text" name="name" class="form-control" value="{{$service->name}}" required />
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <select name="vehicle" style="color: #fff;" class="form-control">
                                ...
                                <option value="{{$vehicles->registration_No}}"{{($vehicles->registration_No==$service->vehicle)? "selected" : "" }}>{{$vehicles->registration_No}}</option>  
                                @endforeach
                              </select>
                            </div>
                          </div>
                      ...
                      <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input style="color: #fff; background-color:#191c24;" name="pdos"  class="form-control" type="date" value="{{$service->pdos}}" required/>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input style="color: #fff; background-color:#191c24;" name="dos"  class="form-control" type="date" value="{{$service->dos}}" required />
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                              <div class="form-check">
                                <label class="form-check-label">
                                  <input type="radio" class="form-check-input" name="membershipRadios" id="membershipRadios1" value="Minor Servicing" {{ $service->servicetype == 'Minor Servicing' ? 'checked' : '' }}> Minor Servicing </label>
                              </div>
                            </div>
                            <div class="col-sm-5">
                              <div class="form-check">
                                <label class="form-check-label">
                                  <input type="radio" class="form-check-input" name="membershipRadios" id="membershipRadios2" value="Major Servicing" {{ $service->servicetype == 'Major Servicing' ? 'checked' : '' }}> Major Servicing </label>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <select name="garage" style="color: #fff;" class="form-control">
                                ...
                                <option value="{{$garages->name}}"{{ ($garages->name==$service->garage)? "selected" : "" }}>{{$garages->name}}</option>     
                                @endforeach
                              </select>
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <select name="mechanic" style="color: #fff;" class="form-control">
                                ...
                                <option value="{{$mechanics->name}}"{{ ($mechanics->name==$service->mechanic)? "selected" : "" }}>{{$mechanics->name}}</option>     
                                @endforeach
                              </select>
                            </div>
                          </div>
                      ...
                      <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input style="color: #fff; background-color:transparent;" name="cmileage" value="{{$service->cmileage}}"  type="text" class="form-control" required/>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input style="color: #fff; background-color:transparent;" name="nmileage" value="{{$service->nmileage}}"  type="text" class="form-control" />
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input style="color: #fff; background-color:transparent;" name="amount" value="{{$service->amount}}"  type="text" class="form-control" required/>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input style="color: #fff; background-color:transparent;" name="report" value="{{$service->report}}"  type="text" class="form-control" />
                            </div>
                          </div>
                        </div>
                      </div>
